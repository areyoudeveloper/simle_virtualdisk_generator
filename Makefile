...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = imggen-gui1.0.0
DISTDIR = /home/tea/build-Diskgen-Desktop-Debug/.tmp/imggen-gui1.0.0
LINK          = g++
LFLAGS        = 
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		Diskgen.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = imggen-gui
DESTDIR       = 
TARGET        = imggen-gui
...
Makefile: Diskgen.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Diskgen.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
moc_mainwindow.cpp: mainwindow.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /home/tea/build-Diskgen-Desktop-Debug/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++ -I/home/tea/Diskgen -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I. -I/usr/include/c++/8 -I/usr/include/x86_64-linux-gnu/c++/8 -I/usr/include/c++/8/backward -I/usr/lib/gcc/x86_64-linux-gnu/8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include mainwindow.h -o moc_mainwindow.cpp
...
imggen-cli:imggen-cli.o

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/imggen-gui/bin || mkdir -p $(INSTALL_ROOT)/opt/imggen-gui/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/imggen-gui/bin/$(QMAKE_TARGET)
install:
	cp 'imggen-gui' /usr/bin
	cp 'imggen-cli' /usr/bin/imggen-cli
	chmod +x /usr/bin/imggen-cli
	chmod +x /usr/bin/imggen-gui
uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/imggen-gui/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/imggen-gui/bin/ 
